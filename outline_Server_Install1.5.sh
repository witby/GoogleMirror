...
echo -e "\033[33m Version：1.4 Bate 2018 \033[0m"
...
echo -e "\033[33m https://github.com/coding1618/Google-images-shell/blob/master/outline_Server_Install1.4.sh \033[0m"
