...
echo -e "\033[33m 本脚本开源地址： \033[0m"
echo -e "\033[33m https://github.com/coding1618/Google-images-shell/blob/master/outline_Server_Install1.3.sh \033[0m"
echo -e "\033[36m ===========================================================\033[0m"
echo -e "\033[36m 文字教程提供:allenking1028									\033[0m"
echo -e "\033[36m 文字教程地址:https://github.com/allenking1028/ss/issues/5  \033[0m"
echo -e "\033[36m =========================================================== \033[0m"
...
echo -e "\033[32m      Google Outline已经安装成功！       \033[0m"
echo -e "\033[32m    请记得手动在防火墙里添加端口哦！！      \033[0m"
echo -e "\033[32m       你也可以直接关闭系统防火墙！        \033[0m"
echo -e "\033[32m   Outline官网:https://getoutline.org        \033[0m"
